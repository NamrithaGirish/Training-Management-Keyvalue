...
export class MaterialController {
  ...
  async createMaterial(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const session = await this.materialService.createMaterial(materialDto);
  ...
  async updateMaterial(req: Request, res: Response, next: NextFunction) {
      try {
        ...
        const updatedMaterial = await this.materialService.updateMaterial(materialId,materialDto);
