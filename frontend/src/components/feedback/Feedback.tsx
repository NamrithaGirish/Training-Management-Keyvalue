    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-[#1E1E1E] text-white rounded-lg shadow-lg w-full max-w-md p-6 border border-gray-700">
        ...
        <div className="mb-6">
          ...
          <div className="flex space-x-1">
            {[1, 2, 3, 4, 5].map((star) => (
              ...
              >
                <span className={
                  `text-2xl ${star <= (hover || rating) ? 'text-yellow-400' : 'text-gray-400'}`
                }>
                  ★
                </span>
              </button>
        ...
        <div className="flex justify-end space-x-3">
          <button className="bg-white text-black px-4 py-2 rounded-md hover:bg-gray-200">Cancel</button>
          <button className="border border-white px-4 py-2 rounded-md hover:bg-gray-700">Submit</button>
        </div>
      </div>
    </div>
  );
