...
const EventList: React.FC<EventListProps> = ({
    ...
    return (
        <div className="p-4 text-white w-full">
            <div className="flex justify-between items-center mb-4 border border-borderColor p-4 rounded-lg bg-cardColor">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    >
                        <option className="bg-itemColor" value="Active">Active</option>
                        <option className="bg-itemColor" value="Scheduled">Scheduled</option>
                        <option className="bg-itemColor" value="Completed">Completed</option>
                    </select>
            ...
            <div className="space-y-4">
                {filteredData.map((item, index) => (
                    <div
                        key={index}
                        className="border border-gray-700 p-4 rounded-lg bg-[#121212]"
                    >
